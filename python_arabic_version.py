...
"padding: 4px; color: black")
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    ...
    def insert_data(self):
                ...
                vartemplimit=[cplusminus+' 2 Temperature',cplusminus+' 3 Temperature',cplusminus+' 4 Temperature',cplusminus+' 5 Temperature']
                for i,x in enumerate(vartemplimit):
                    QTreeWidgetItem(self.dataView,[x,str(i)])
    def call_back(self):
        self.close()
        #self.destroy()
        #gc.collect()
...
"padding: 4px; color: black")
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    ...
    def insert_data(self):
                #print(i,x)
                QTreeWidgetItem(self.dataView,['English',"1"])
                QTreeWidgetItem(self.dataView,['Arabic',"2"])
    def call_back(self):
        self.close()
        self.destroy()
        gc.collect()
...
"padding: 4px; color: black")
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    ...
    def insert_data(self):
                #print(i,x)
                QTreeWidgetItem(self.dataViewss,[str("\u0625\u0637\u0644\u0627\u0642\u064b\u0627"),'1'])
                QTreeWidgetItem(self.dataViewss,[str("\u0035 \u062f\u0642\u0627\u0626\u0642"),'2'])
                QTreeWidgetItem(self.dataViewss,[str("\u0031\u0030 \u062f\u0642\u0627\u0626\u0642"),'3'])
    def call_back(self):
        self.close()
        self.destroy()
        gc.collect()
...
"padding: 4px; color: black")
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    ...
    def insert_data(self):
                #print(i,x)
                QTreeWidgetItem(self.dataView,['HP_LaserJet_Pro_M12a','1'])
                QTreeWidgetItem(self.dataView,['HP_Deskjet_Ink_Advantage_2138_All-in_one_Printer','2'])
                QTreeWidgetItem(self.dataView,["HP_DeskJet_2130_series",'3'])
    def call_back(self):
        self.close()
        #self.destroy()
        #gc.collect()
...
class result_window(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.comboBox.setStyleSheet("font: 87 15pt \"Arial\";background-color: rgb(241, 241, 241); padding-left:100px;")
...
"padding: 4px; color: black")
    ...
    def insert_data(self):
            ...
            for i,x in enumerate(l):
                #print(i,x)
                QTreeWidgetItem(self.dataView,[x[0],str(i)])
    def call_back(self):
        self.close()
        #self.destroy()
        #gc.collect()
...
"font: 75 16pt \"Arial\";")
        ...
        self.comboBox.setMinimumWidth(250);
        self.comboBox.setStyleSheet("font: 87 15pt \"Arial\";background-color: rgb(241, 241, 241); padding-left:100px;")
        self.comboBox.setGeometry(QRect(195, 430, 231, 41))
        self.comboBox.setCursor(QCursor(Qt.ArrowCursor))
        self.comboBox.setAcceptDrops(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.comboBox_2.setStyleSheet("font: 87 15pt \"Arial\";background-color: rgb(241, 241, 241); padding-left:100px;")
        self.comboBox_2.setGeometry(QRect(195, 510, 231, 41))
...
"padding: 4px; color: black")
    ...
    def retranslateUi(self):
       # _translate = QCoreApplication.translate
        ...
        self.TestScreen_3.setText( str("\u0636\u0628\u0637 \u0627\u0644\u0645\u0624\u0642\u062a \u002f \u0648\u0636\u0639 infinity"))
...
##           QTreeWidgetItem(self.dataView,x) 
    ...
    def insert_data(self):
            ...
            for i,x in enumerate(l):
                #print(i,x)
                QTreeWidgetItem(self.dataView,[x[3],x[2],x[1],x[0],str(i),x[4]]) 
