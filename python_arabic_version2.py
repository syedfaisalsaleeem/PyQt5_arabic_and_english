...
class exportallresults(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label = QLabel('\u0646\u062a\u0627\u0626\u062c \u0627\u0644\u062a\u0635\u062f\u064a\u0631',self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(300,125,270,50)


        self.etd = QPushButton(str("\u062a\u0635\u062f\u064a\u0631 \u062c\u0645\u064a\u0639 \u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a \u0627\u0644\u0645\u062c\u062f\u0648\u0644\u0629"), self)
        self.etd.setGeometry(120,330,300,80)
...
"padding: 4px; color: black")
        ...
        self.eag = QPushButton(str("\u062a\u0635\u062f\u064a\u0631 \u062c\u0645\u064a\u0639 \u0627\u0644\u0631\u0633\u0648\u0645\u0627\u062a"), self)
        self.eag.setGeometry(120,470,300,80)
...
"padding: 4px; color: black")
        ...
        self.etp = QPushButton(str("\u062a\u0635\u062f\u064a\u0631 \u062c\u0645\u064a\u0639 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631\u0627\u062a \u0627\u0644\u062a\u064a \u062a\u0645 \u0627\u0644\u0642\u064a\u0627\u0645 \u0628\u0647\u0627"), self)
        self.etp.setGeometry(120,620,300,80)
...
"padding: 4px; color: black")
        ...
        self.save = QPushButton(str("\u0637\u0628\u0627\u0639\u0629 \u062c\u0645\u064a\u0639 \u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a \u0627\u0644\u0645\u062c\u062f\u0648\u0644\u0629"), self)
...
"padding: 4px; color: black")
        ...
        self.save = QPushButton(str("\u0637\u0628\u0627\u0639\u0629 \u062c\u0645\u064a\u0639 \u0627\u0644\u0631\u0633\u0648\u0645\u0627\u062a"), self)
...
"padding: 4px; color: black")
        ...
        self.save = QPushButton(str("\u0637\u0628\u0627\u0639\u0629 \u062c\u0645\u064a\u0639 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631\u0627\u062a \u0627\u0644\u062a\u064a \u062a\u0645 \u0627\u0644\u0642\u064a\u0627\u0645 \u0628\u0647\u0627"), self)
        self.save.setGeometry(540,620,300,80)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        self.back.setGeometry(80,202,241,61)
...
class masterpasswordscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('graph_screen1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629"),self)
        self.label.setFont(QFont('Arial', 21))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(300,125,270,50)    

        self.nsp = QLabel(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0627\u0644\u062e\u062f\u0645\u0629 \u0627\u0644\u062c\u062f\u064a\u062f\u0629"),self)
        self.nsp.setFont(QFont('Arial', 18))
        self.nsp.setStyleSheet('background-color:white; color: black')
        self.nsp.setGeometry(590,320,270,50)


        self.cp = QLabel(str("\u0623\u0643\u062f \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"),self)
        self.cp.setFont(QFont('Arial', 18))
        self.cp.setStyleSheet('background-color:white; color: black')
        self.cp.setGeometry(590,440,270,50)


        self.e_nsp = extQLineEdit1(self)
        self.e_nsp .setFont(QFont('Arial', 18))
        self.e_nsp .setGeometry(90,320,500,53)
        self.e_nsp .setStyleSheet('background-color:white; color: black')
        self.e_nsp .setPlaceholderText(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0627\u0644\u062e\u062f\u0645\u0629 \u0627\u0644\u062c\u062f\u064a\u062f\u0629"))
        ...
        self.e_cp.setGeometry(90,440,500,53)
        self.e_cp.setStyleSheet('background-color:white; color: black')
        self.e_cp.setPlaceholderText(str("\u0623\u0643\u062f \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"))
        ...
        self.save = QPushButton(str("\u062d\u0641\u0638"), self)
        self.save.setGeometry(350,202,241,61)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
    ...
    def save1(self):
        ...
        if(len(self.e_nsp.text())==0 or len(self.e_cp.text())==0 ):
            ...
            self.popup1=popup1(name="\u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0627\u0644\u062c\u062f\u064a\u062f\u0629 \u0644\u0627 \u062a\u062a\u0637\u0627\u0628\u0642 \u0645\u0639 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0627\u0644\u0645\u0624\u0643\u062f\u0629",name2='Close')
            self.popup1.show()
            ...
            c.close()               
            conn.close()
            self.popup1=popup2(name="\u062a\u0645 \u062a\u062d\u062f\u064a\u062b \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631  ",name2='Close')
            self.popup1.show()
            self.close()
            #self.destroy()
            #gc.collect()
...
class servicepasswordscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('graph_screen1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u062a\u063a\u064a\u064a\u0631 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"),self)
        self.label.setFont(QFont('Arial', 21))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(410,120,300,50)

        self.lcp = QLabel(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0627\u0644\u062d\u0627\u0644\u064a\u0629"),self)
        self.lcp.setFont(QFont('Arial', 18))
        self.lcp.setStyleSheet('background-color:white; color: black')
        self.lcp.setGeometry(590,320,270,50)


        self.lnp = QLabel(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0627\u0644\u062c\u062f\u064a\u062f\u0629"),self)
        self.lnp.setFont(QFont('Arial', 18))
        self.lnp.setStyleSheet('background-color:white; color: black')
        self.lnp.setGeometry(590,440,270,50)


        self.lcnp = QLabel(str("\u0623\u0643\u062f \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"),self)
        self.lcnp.setFont(QFont('Arial', 18))
        self.lcnp.setStyleSheet('background-color:white; color: black')
        self.lcnp.setGeometry(590,560,270,50)

        self.e_cp = extQLineEdit1(self)
        self.e_cp .setFont(QFont('Arial', 18))
        self.e_cp .setGeometry(90,320,500,53)
        self.e_cp .setStyleSheet('background-color:white; color: black')
        self.e_cp .setPlaceholderText(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0627\u0644\u062d\u0627\u0644\u064a\u0629"))
        self.e_cp.setReadOnly(True)
        self.e_cp.setEchoMode(QLineEdit.Password)
        ...
        self.e_np.setGeometry(90,440,500,53)
        self.e_np.setStyleSheet('background-color:white; color: black')
        self.e_np.setPlaceholderText(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0627\u0644\u062c\u062f\u064a\u062f\u0629"))
        ...
        self.e_cnp.setGeometry(90,560,500,53)
        self.e_cnp.setStyleSheet('background-color:white; color: black')
        self.e_cnp.setPlaceholderText(str("\u0623\u0643\u062f \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"))
...
"padding: 4px; color: black")
    ...
    def save1(self):
        if(self.e_cp.text()!=self.passwordoriginal):
            ...
            self.popup1=popup1(name='\u0645\u0646 \u0641\u0636\u0644\u0643 \u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0627\u0644\u0633\u0627\u0628\u0642\u0629 \u0627\u0644\u0635\u062d\u064a\u062d\u0629',name2='Close')
            self.popup1.show()
            ...
            self.popup1=popup1(name="\u0644\u0627 \u064a\u0645\u0643\u0646\u0643 \u062a\u0639\u064a\u064a\u0646 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0627\u0644\u062d\u0627\u0644\u064a\u0629  ",name2='Close')
            self.popup1.show()
            ...
            c.close()               
            conn.close()
            self.popup1=popup2(name=str("\u062a\u0645 \u062a\u062d\u062f\u064a\u062b \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631         "),name2='Close')
            self.popup1.show()
            self.close()
            #self.destroy()
            #gc.collect()
...
class alarmscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u062d\u0627\u0644\u0629 \u0627\u0644\u0645\u0646\u0628\u0629"),self)
        self.label.setFont(QFont('Arial', 27))
        ...
        self.dataView.setHeaderLabels([str("\u0645\u062f\u0629"),str("\u062d\u0627\u0644\u0629 \u0627\u0644\u0645\u0646\u0628\u0629"),str("\u0627\u0644\u0648\u0642\u062a"),str("\u0627\u0644\u062a\u0627\u0631\u064a\u062e"),str('\u0631\u0642\u0645')])
...
class powerscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0627\u0644\u0637\u0627\u0642\u0629"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(300,125,270,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        ...
        self.dataView.setAlternatingRowColors(True)
        self.dataView.setRootIsDecorated(False)
        self.dataView.setHeaderLabels([str("\u0627\u0644\u0637\u0627\u0642\u0629"),str("\u0627\u0644\u0648\u0642\u062a"),str("\u0627\u0644\u062a\u0627\u0631\u064a\u062e"),str("\u0631\u0642\u0645")])
        self.dataView.header().setStyleSheet('padding-top:-2px;background-color:white;font-size:21pt; font-family: Arial;border-width:1px;border-style:outset;border-color:black; ')
        self.dataView.header().setDefaultAlignment(Qt.AlignRight)
        #self.dataView.header().setResizeMode(1, QHeaderView.Stretch)
        #self.dataView.header().setResizeMode(2, QHeaderView.Stretch)
...
class calibrationscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('graph_screen1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0645\u0639\u0627\u064a\u0631\u0629"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(300,125,270,50)
    
        self.c1 = QPushButton(str("\u0645\u0639\u0627\u064a\u0631\u0629 \u0646\u0642\u0637\u0629 \u0031 "), self)
...
"padding: 4px; color: black")
        ...
        self.c2 = QPushButton(str("\u0645\u0639\u0627\u064a\u0631\u0629 \u0646\u0642\u0637\u0629 \u0032 "), self)
...
"padding: 4px; color: black")
        ...
        self.c3 = QPushButton(str("\u0645\u0639\u0627\u064a\u0631\u0629 \u0646\u0642\u0637\u0629 \u0033  "), self)
...
class testing(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('graph_screen1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0623\u062c\u0647\u0632\u0629 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(350,125,300,50)
        self.ins_settings = QPushButton(str("\u062e\u062a\u0628\u0627\u0631 \u0627\u0644\u0637\u0627\u0628\u0639\u0629"), self)
...
"padding: 4px; color: black")
        ...
        self.service = QPushButton(str("\u0627\u062e\u062a\u0628\u0627\u0631 \u0627\u0644\u0635\u0641\u0627\u0631\u0629"), self)
...
class notification1(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.b_power = QPushButton(str("\u0625\u0646\u0642\u0637\u0627\u0639 \u0627\u0644\u0637\u0627\u0642\u0629"), self)
...
"padding: 4px; color: black")
        ...
        self.b_alarm = QPushButton(str("\u0645\u0646\u0628\u0629"), self)
...
class selecttemperaturelimit(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0627\u0644\u062d\u062f \u0627\u0644\u0623\u0642\u0649 \u0644\u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(350,125,300,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        ...
        self.selectuser = QPushButton(str("\u062d\u0641\u0638"), self)
        self.selectuser.setGeometry(350,202,241,61)
...
"padding: 4px; color: black")
        ...
        self.dataView.setAlternatingRowColors(True)
        self.dataView.setRootIsDecorated(False)
        self.dataView.setHeaderLabels([str("\u0627\u062e\u062a\u0631 \u0627\u0644\u062d\u062f \u0627\u0644\u0623\u0642\u0649 \u0644\u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629"),str("\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062c\u0639\u064a")])
        self.dataView.header().setStyleSheet('padding-top:-2px;background-color:white;font-size:21pt; font-family: Arial;border-width:1px;border-style:outset;border-color:black; ')
        self.dataView.header().setDefaultAlignment(Qt.AlignRight)
        #self.dataView.header().setResizeMode(1, QHeaderView.Stretch)
        #self.dataView.header().setResizeMode(2, QHeaderView.Stretch)
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    ...
    def insert_data(self):
                ...
                vartemplimit=[cplusminus+' 2 Temperature',cplusminus+' 3 Temperature',cplusminus+' 4 Temperature',cplusminus+' 5 Temperature']
                for i,x in enumerate(vartemplimit):
                    xa=QTreeWidgetItem(self.dataView,[x,str(i)])
    ...
    def call_save(self):
        try:
            temperature_limit.limit=self.getChildNode[1:3]
            print(int(temperature_limit.limit))
            self.close()
            self.userswindow=second_servicewindow(self.mainwindow)
            windoww.win.addSubWindow(self.userswindow)
            self.userswindow.show()
...
class selecttimezone(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0627\u062e\u062a\u0631 \u0627\u0644\u0646\u0637\u0627\u0642 \u0627\u0644\u0632\u0645\u0646\u064a"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(300,125,270,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
...
"padding: 4px; color: black")
        ...
        self.dataView.setAlternatingRowColors(True)
        self.dataView.setRootIsDecorated(False)
        self.dataView.setHeaderLabels([str("\u0627\u062e\u062a\u0631 \u0627\u0644\u0646\u0637\u0627\u0642 \u0627\u0644\u0632\u0645\u0646\u064a"),"\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062c\u0639\u064a"])
        self.dataView.header().setStyleSheet('padding-top:-2px;background-color:white;font-size:21pt; font-family: Arial;border-width:1px;border-style:outset;border-color:black; ')
        self.dataView.header().setDefaultAlignment(Qt.AlignRight)
        #self.dataView.header().setResizeMode(1, QHeaderView.Stretch)
        #self.dataView.header().setResizeMode(2, QHeaderView.Stretch)
...
class selectlanguage(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0627\u062e\u062a\u0631\u0627\u0644\u0644\u063a\u0629"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(300,125,270,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
...
"padding: 4px; color: black")
        ...
        self.dataView.setAlternatingRowColors(True)
        self.dataView.setRootIsDecorated(False)
        self.dataView.setHeaderLabels([str("\u0627\u062e\u062a\u0631\u0627\u0644\u0644\u063a\u0629"),str("\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062c\u0639\u064a")])
        self.dataView.header().setStyleSheet('padding-top:-2px;background-color:white;font-size:21pt; font-family: Arial;border-width:1px;border-style:outset;border-color:black; ')
        self.dataView.header().setDefaultAlignment(Qt.AlignRight)
        #self.dataView.header().setResizeMode(1, QHeaderView.Stretch)
        #self.dataView.header().setResizeMode(2, QHeaderView.Stretch)
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    ...
    def insert_data(self):
                #print(i,x)
                xa=QTreeWidgetItem(self.dataView,['English',"1"])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
                xb=QTreeWidgetItem(self.dataView,['Arabic',"2"])
                xb.setTextAlignment(0,Qt.AlignRight)
                xb.setTextAlignment(1,Qt.AlignRight)
    def call_back(self):
        self.close()
        self.destroy()
        gc.collect()
...
class selectscreentimeout(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0647\u0644\u0629"),self)
        self.label.setFont(QFont('Arial', 19))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(400,120,220,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        self.back = QPushButton(back, self)
        self.back.setGeometry(30,200,240,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet(stylesheet.back)
        self.back.clicked.connect(self.call_back)
        
        self.selectuser = QPushButton(str("\u062d\u0641\u0638"), self)
        self.selectuser.setGeometry(750,200,240,70)
        self.selectuser.setFont(QFont('Arial', 21))
        self.selectuser.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        self.dataViewss.setHeaderLabels([str("\u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0647\u0644\u0629"),str("\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062c\u0639\u064a")])
        ...
        #self.dataView.setSizeHint(0,QSize(10,10))
        self.dataViewss.setColumnWidth(0,800)
        self.dataViewss.setColumnWidth(1,0)
        ...
        self.dataViewss.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)
        QScroller.grabGesture(self.dataViewss.viewport(), QScroller.LeftMouseButtonGesture)
        self.dataViewss.setVerticalScrollMode(QAbstractItemView.ScrollPerPixel)
        self.dataViewss.itemClicked.connect(self.onItemClicked)
        self.insert_data()
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    def onItemClicked(self):
        global getChildNode
        getSelected = self.dataViewss.selectedItems()
        #if getSelected:
        baseNode = getSelected[0]
        getChildNode = baseNode.text(1)
        #self.dataView.setIconSize(QSize(32,32))
    ...
    def insert_data(self):
                #print(i,x)
                xa=QTreeWidgetItem(self.dataViewss,[str("\u0625\u0637\u0644\u0627\u0642\u064b\u0627"),'1'])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
                xa.setTextAlignment(2,Qt.AlignRight)
                xa=QTreeWidgetItem(self.dataViewss,[str("\u0035 \u062f\u0642\u0627\u0626\u0642"),'2'])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
                xa.setTextAlignment(2,Qt.AlignRight)
                xa=QTreeWidgetItem(self.dataViewss,[str("\u0031\u0030 \u062f\u0642\u0627\u0626\u0642"),'3'])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
                xa.setTextAlignment(2,Qt.AlignRight)
    def call_back(self):
...
class selectprinter(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0627\u062e\u062a\u0631 \u0627\u0644\u0637\u0627\u0628\u0639\u0629"),self)
        self.label.setFont(QFont('Arial', 19))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(400,120,220,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
...
"padding: 4px; color: black")
        ...
        self.dataView.setAlternatingRowColors(True)
        self.dataView.setRootIsDecorated(False)
        self.dataView.setHeaderLabels([str("\u0627\u062e\u062a\u0631 \u0627\u0644\u0637\u0627\u0628\u0639\u0629"),str("\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062c\u0639\u064a")])
        self.dataView.header().setStyleSheet('padding-top:-2px;background-color:white;font-size:21pt; font-family: Arial;border-width:1px;border-style:outset;border-color:black; ')
        self.dataView.header().setDefaultAlignment(Qt.AlignRight)
        #self.dataView.header().setResizeMode(1, QHeaderView.Stretch)
        #self.dataView.header().setResizeMode(2, QHeaderView.Stretch)
   ...
   # @QtCore.pyqtSlot(QTreeWidgetItem, int)
    ...
    def insert_data(self):
                #print(i,x)
                xa=QTreeWidgetItem(self.dataView,['HP_LaserJet_Pro_M12a','1'])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
                xa=QTreeWidgetItem(self.dataView,['HP_Deskjet_Ink_Advantage_2138_All-in_one_Printer','2'])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
                xa=QTreeWidgetItem(self.dataView,["HP_DeskJet_2130_series",'3'])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
    def call_back(self):
        self.close()
...
class second_servicewindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label = QLabel(str("\u0634\u0627\u0634\u0629 \u0627\u0644\u062e\u062f\u0645\u0629"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(300,125,270,50)
        self.home = QPushButton(str("\u0627\u0644\u0635\u0641\u062d\u0629 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629"), self)
        self.home.setGeometry(350,202,241,61)
...
"padding: 4px; color: black")
        ...
        self.back.setStyleSheet(stylesheet.back)
        self.back.clicked.connect(self.call_back)
        self.language = QPushButton(str("\u0627\u0644\u0644\u063a\u0629"), self)
        self.language.setGeometry(710,230,250,90)
...
"padding: 4px; color: black")
        ...
        self.timezone = QPushButton(str("\u0627\u0644\u0646\u0637\u0627\u0642 \u0627\u0644\u0632\u0645\u0646\u064a"), self)
        self.timezone.setGeometry(710,350,250,90)
...
"padding: 4px; color: black")
        ...
        self.temp_limit = QPushButton(str("\u0627\u0644\u062d\u062f \u0627\u0644\u0646\u0647\u0627\u0626\u064a \u0644\u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629"), self)
        self.temp_limit.setGeometry(710,470,250,90)
...
"padding: 4px; color: black")
        ...
        self.performance = QPushButton(str("\u0627\u0644\u0623\u062f\u0627\u0621"), self)
        self.performance.setGeometry(710,590,250,90)
...
"padding: 4px; color: black")
        ...
        self.calibration = QPushButton(str("\u0645\u0639\u0627\u064a\u0631\u0629"), self)
...
"padding: 4px; color: black")
        ...
        self.password = QPushButton(str("\u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"), self)
...
"padding: 4px; color: black")
        ...
        self.s_update = QPushButton(str("\u062a\u062d\u062f\u064a\u062b \u0627\u0644\u062e\u062f\u0645\u0629"), self)
...
"padding: 4px; color: black")
        ...
        self.f_reset = QPushButton(str("\u0625\u0639\u0627\u062f\u0629 \u0636\u0628\u0637 \u0627\u0644\u0645\u0635\u0646\u0639"), self)
        self.f_reset.setGeometry(120,350,250,90)
...
"padding: 4px; color: black")
        ...
        self.test = QPushButton(str("\u0623\u062c\u0647\u0632\u0629 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631"), self)
        self.test.setGeometry(120,470,250,90)
...
"padding: 4px; color: black")
        ...
        self.ethernet = QPushButton(str("\u0625\u064a\u062b\u0631\u0646\u062a"), self)
        self.ethernet.setGeometry(120,590,250,90)
...
class servicepasswordwindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setGeometry(300,125,270,50)
        ...
        self.e_password = QPushButton(str("\u0623\u062f\u062e\u0644 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631"), self)
...
class settingswindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('graph_screen1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label2 = QLabel(str('\u0627\u0644\u0625\u0639\u062f\u0627\u062f\u0627\u062a'),self)
        self.label2.setFont(QFont('Arial', 27))
        self.label2.setStyleSheet('background-color:white; color: black')
        self.label2.setGeometry(300,125,270,50)
        self.ins_settings = QPushButton(str("\u0625\u062e\u0637\u0627\u0631"), self)
        self.ins_settings.setFont(QFont('Arial', 25))
        self.ins_settings.setGeometry(370,300,285,155)
        self.ins_settings.setStyleSheet('background-image: url(setting2.png);')
        self.ins_settings.clicked.connect(self.instrumentsettingswindow)
        self.service = QPushButton(str("\u062e\u062f\u0645\u0629"), self)
        self.service.setFont(QFont('Arial', 25))
        self.service.setGeometry(370,500,285,155)
        self.service.setStyleSheet('background-image: url(setting2.png);')
        self.service.clicked.connect(self.servicewindow)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        self.back = QPushButton(back, self)
        self.back.setGeometry(80,202,241,61)
...
class instrumentwindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.background.setPixmap(QPixmap('graph_screen1.png'))
        self.background.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0634\u0627\u0634\u0629 \u0627\u0644\u062a\u062b\u0628\u064a\u0637"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(300,125,270,50)
        self.home = QPushButton(str("\u0627\u0644\u0635\u0641\u062d\u0629 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629"), self)
...
"padding: 4px; color: black")
        ...
        self.back.clicked.connect(self.call_back)
        self.save = QPushButton(str("\u062d\u0641\u0638"), self)
        self.save.setGeometry(620,202,241,61)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        self.save.clicked.connect(self.save1)
        self.c_name = QLabel(str("\u0627\u0633\u0645 \u0627\u0644\u0634\u0631\u0643\u0629"),self)
        self.c_name.setFont(QFont('Arial', 20))
        self.c_name.setStyleSheet('background-color:white; color: black')
        self.c_name.setGeometry(670,280,220,50)
        self.c_name_entry = extQLineEdit1(self)
        self.c_name_entry.setFont(QFont('Arial', 16))
        self.c_name_entry.setGeometry(670,330,220,40)
        ...
        self.tele_no = QLabel(str("\u0631\u0642\u0645 \u0627\u0644\u062a\u0644\u064a\u0641\u0648\u0646"),self)
        self.tele_no.setFont(QFont('Arial', 20))
        self.tele_no.setStyleSheet('background-color:white; color: black')
        self.tele_no.setGeometry(670,370,220,50)
        self.tele_no_entry = extQLineEdit1(self)
        self.tele_no_entry.setFont(QFont('Arial', 16))
        self.tele_no_entry.setGeometry(670,420,220,40)
        ...
        self.progress_l = QLabel(str("\u0645\u0633\u0627\u062d\u0629 \u0627\u0644\u0642\u0631\u0635"),self)
        self.progress_l.setFont(QFont('Arial', 20))
        self.progress_l .setStyleSheet('background-color:white; color: black')
        self.progress_l .setGeometry(240,560,220,50)
        self.progress = QProgressBar(self)
        self.progress.setGeometry(200, 610, 300, 25)
        self.progress.setMaximum(100)
        self.progress.setInvertedAppearance(True)
        self.progress.setValue(obj_Disk.percent)
        self.progress_2 = QLabel(str("100%"),self)
        self.progress_2.setFont(QFont('Arial', 10))
        self.progress_2 .setStyleSheet('background-color:white; color: black')
        self.progress_2 .setGeometry(170,600,35,50) 
        self.screentimeout = QLabel(str("\u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0647\u0644\u0629"),self)
        self.screentimeout.setFont(QFont('Arial', 20))
        self.screentimeout.setStyleSheet('background-color:white; color: black')
        self.screentimeout.setGeometry(240,280,220,50)
        self.b_timeout = QPushButton(str("\u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0647\u0644\u0629"), self)
        self.b_timeout.setGeometry(240,330,220,70)
...
"padding: 4px; color: black")
        ...
        self.printer = QLabel(str("\u0627\u0644\u0637\u0627\u0628\u0639\u0629"),self)
        self.printer.setFont(QFont('Arial', 20))
...
# "border-color: black;\n"
# "padding: 4px; color: black")
        self.printer.setGeometry(240,420,220,50)
        self.b_printer = QPushButton(str('\u0627\u062e\u062a\u0631 \u0627\u0644\u0637\u0627\u0628\u0639\u0629'), self)
        self.b_printer.setGeometry(240,470,220,70)
...
"padding: 4px; color: black")
    ...
    def save1(self):
        ...
        c.close()               
        conn.close()
        self.popup1=popup2(name=str('\u062a\u0645 \u0627\u0644\u062a\u062d\u0648\u064a\u0644 \u0625\u0644\u0649 \u0627\u0644\u062a\u062b\u0628\u064a\u0637 \u0628\u0646\u0633\u0628\u0629                   '),name2=str("\u0625\u063a\u0644\u0627\u0642"))
        self.popup1.show()
...
class damper_screen(QMdiSubWindow):
    ...
    def InitUI1(self):
        ...
        self.d_off = QPushButton(str("\u0625\u064a\u0642\u0627\u0641 %0"), self)
        self.d_off.setCheckable(True)
        self.d_off.setGeometry(705,240,240,120)
        ...
        self.d_50 = QPushButton('\u0627\u0644\u0646\u0635\u0641 %50', self)
        self.d_50.setCheckable(True)
        self.d_50.setGeometry(705,390,240,120)
        ...
        self.d_100 = QPushButton('\u0628\u0627\u0644\u0643\u0627\u0645\u0644 %100', self)
        self.d_100.setCheckable(True)
        self.d_100.setChecked(bool(self.d100))
        self.d_100.setGeometry(705,540,240,120)
    ...
    def d_50_on(self,d50):
        ...
        self.popup1=popup2(name=str('\u062a\u0645 \u0627\u0644\u062a\u062d\u0648\u064a\u0644 \u0625\u0644\u0649 \u0627\u0644\u062a\u062b\u0628\u064a\u0637 \u0628\u0646\u0633\u0628\u0629 %50           '),name2=str('\u0625\u063a\u0644\u0627\u0642'))
        self.popup1.show()
    ...
    def d_off_on(self,doff):
        ...
        c.close()               
        conn.close()
        self.popup1=popup2(name=str('\u062a\u0645 \u0627\u0644\u062a\u062d\u0648\u064a\u0644 \u0625\u0644\u0649 \u0627\u0644\u062a\u062b\u0628\u064a\u0637 \u0628\u0646\u0633\u0628\u0629 %0            '),name2=str('\u0625\u063a\u0644\u0627\u0642'))
        self.popup1.show()
    ...
    def d_100_on(self,d100):
        ...
        c.close()               
        conn.close()
        self.popup1=popup2(name=str('\u062a\u0645 \u0627\u0644\u062a\u062d\u0648\u064a\u0644 \u0625\u0644\u0649 \u0627\u0644\u062a\u062b\u0628\u064a\u0637 \u0628\u0646\u0633\u0628\u0629 %100            '),name2=str('\u0625\u063a\u0644\u0627\u0642'))
        self.popup1.show()
    def call_first1(self):
        self.close()
        #self.destroy()
...
class about_screen(QMdiSubWindow):
    ...
    def InitUI1(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        about1=u'\u0639'+u'\u0646'+u'\u0646'+u'\u0627'
        self.label = QLabel(about1,self)
        self.label.setFont(QFont('Arial', 28))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(270,125,270,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        self.back = QPushButton(back, self)
        self.back.setGeometry(80,202,241,61)
        self.back.setFont(QFont('Arial', 21))
        ...
        self.plainText.setGeometry(10,300,1000,450)
        self.plainText.setAlignment(Qt.AlignRight)
        utf16string=str('\u062a\u0645 \u062a\u0623\u0633\u064a\u0633 \u0041\u006e\u0061\u006d\u0065\u0064 \u0053\u0079\u0073\u0074\u0065\u006d\u0073 \u0641\u064a \u0032\u0030\u0030\u0036 \u0628\u0647\u062f\u0641 \u0641\u064a \u0644\u062a\u0648\u0641\u064a\u0631 \u0623\u0641\u0636\u0644 \u0623\u062f\u0648\u0627\u062a \u0637\u0628\u064a\u0629 \u0648\u0645\u062e\u062a\u0628\u0631\u064a\u0629 \u0639\u0644\u0649 \u0645\u0633\u062a\u0648\u0649 \u0627\u0644\u0639\u0627\u0644\u0645\u002e  \u062d\u0642\u0642\u062a \u0627\u0644\u0634\u0631\u0643\u0629 \u0628\u0646\u062c\u0627\u062d \u0647\u062f\u0641\u0647\u0627 \u0639\u0644\u0649 \u0645\u062f\u0627\u0631 \u0031\u0033 \u0633\u0646\u0629 \u0641\u064a \u0627\u0644\u0635\u0646\u0627\u0639\u0629 \u0648\u0627\u0644\u0622\u0646 \u0646\u062a\u062d\u0631\u0643 \u0628\u0625\u064a\u0642\u0627\u0639 \u0633\u0631\u064a\u0639 \u0644\u062a\u062d\u0642\u064a\u0642 \u0631\u0624\u064a\u0629 \u0645\u0624\u0633\u0633\u0647\u0627\u002e \u062a\u0645 \u0625\u0646\u0634\u0627\u0621  \u0041\u006e\u0061\u006d\u0065\u0064 \u0053\u0079\u0073\u0074\u0065\u006d\u0073 \u0628\u0647\u062f\u0641 \u062a\u0648\u0641\u064a\u0631 \u0623\u062f\u0648\u0627\u062a \u0637\u0628\u064a\u0629 \u0648\u062e\u062a\u0628\u0631\u064a\u0629 \u0644\u0643\u0644 \u0645\u0643\u0627\u0646 \u0641\u064a \u0627\u0644\u0639\u0627\u0644\u0645\u002e \u0646\u062c\u062d\u062a \u0627\u0644\u0634\u0631\u0643\u0629 \u0641\u064a \u062a\u062d\u0642\u064a\u0642 \u0647\u062f\u0641\u0647\u0627 \u0639\u0644\u0649 \u0645\u062f\u0627\u0631 \u0031\u0033 \u0639\u0627\u0645 \u062f\u0627\u062e\u0644 \u0627\u0644\u0635\u0646\u0627\u0639\u0629 \u0648\u0627\u0644\u0622\u0646 \u0646\u0646\u062a\u0642\u0644 \u0644\u0644\u0623\u0645\u0627\u0645 \u0628\u0648\u062a\u064a\u0631\u0629 \u0633\u0631\u064a\u0639\u0629 \u0644\u062a\u062d\u0642\u064a\u0642 \u0628\u0635\u064a\u0631\u0629 \u0645\u0624\u0633\u0633\u0647\u0627\u002e \u0625\u0646 \u0041\u006e\u0061\u006d\u0065\u0064 \u0053\u0079\u0073\u0074\u0065\u006d\u0073 \u0647\u064a \u0627\u0644\u0645\u0648\u0632\u0639 \u0627\u0644\u0645\u062a\u062e\u0635\u0635 \u0641\u064a \u0633\u0644\u0639 \u062a\u0642\u0646\u064a\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629 \u0627\u0644\u062b\u0648\u0631\u064a\u0629  \u0645\u0646 \u0623\u062c\u0644 \u0627\u0644\u062a\u062c\u0641\u064a\u0641\u060c \u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0648\u062a\u0639\u0642\u064a\u0645 \u0627\u0644\u0647\u0648\u0627\u0621 \u0627\u0644\u0633\u0627\u062e\u0646 \u0627\u0644\u0630\u064a \u064a\u062a\u0645 \u0641\u064a \u0627\u0644\u062f\u0631\u0627\u0633\u0627\u062a\u060c \u0627\u0644\u062a\u062d\u0633\u064a\u0646\u060c \u0627\u0644\u0625\u0646\u062a\u0627\u062c \u0648\u0627\u0644\u0634\u0647\u0627\u062f\u0629 \u0645\u0631\u0636\u064a\u0629\u002e \u0643\u0639\u0636\u0648 \u0641\u064a \u0041\u006e\u0061\u006d\u0065\u0064 \u0053\u0079\u0073\u0074\u0065\u006d\u0073\u060c \u0641\u0625\u0646 \u0627\u0644\u0633\u0639\u0648\u062f\u064a\u0629 \u0645\u062a\u062e\u0635\u0635\u0629 \u0641\u064a \u0627\u0644\u062f\u062e\u0644 \u0648\u0627\u0644\u0646\u0642\u0644 \u0644\u0647\u0630\u0647 \u0627\u0644\u0633\u0644\u0639 \u0627\u0644\u0641\u0627\u0626\u0642\u0629\u002e \u062e\u0637 \u0627\u0644\u0625\u0646\u062a\u0627\u062c \u0627\u0644\u0641\u0627\u0626\u0642 \u062a\u0642\u0646\u064a\u064b\u0627 \u0647\u0630\u0627 \u0647\u0648 \u0645\u0628\u0646\u064a \u0639\u0644\u0649 \u0645\u0639\u0631\u0641\u0629 \u0645\u062a\u0631\u0627\u0643\u0645\u0629 \u0639\u0644\u0649 \u0645\u0631 \u0627\u0644\u0633\u0646\u064a\u0646 \u0648\u062a\u0642\u0627\u0628\u0644 \u0627\u062d\u062a\u064a\u0627\u062c\u0627\u062a \u0627\u0644\u0633\u0648\u0642 \u0627\u0644\u0645\u062a\u063a\u064a\u0631\u0629\u002e \u0627\u0633\u062a\u0634\u0627\u0631\u0629 \u062a\u062e\u0635\u0635\u064a\u0629\u060c \u0634\u0628\u0643\u0629 \u062f\u0648\u0644\u064a\u0629 \u0646\u0634\u0637\u0629 \u0645\u0646 \u0627\u0644\u0645\u0634\u062a\u0631\u064a\u0646 \u0648\u0645\u062c\u0645\u0648\u0639\u0629 \u0645\u0627\u0647\u0631\u0629 \u0645\u0646 \u0627\u0644\u062a\u0642\u0646\u064a\u064a\u0646 \u0627\u0644\u0645\u0633\u0624\u0648\u0644\u064a\u0646 \u0647\u0645 \u0623\u0633\u0627\u0633 \u0633\u0639\u0627\u062f\u0629 \u0627\u0644\u0639\u0645\u0644\u0627\u0621')
        #xs=utf16string.decode('utf-16')

        #plainstring4 = str(utf16string, "utf-16")
...
customers."""
        ...
        self.plainText.append(utf16string)
...
class graphresultwindowsecond(QMdiSubWindow):
    ...
    def InitUI1(self):
        ...
        self.label2 = QLabel(str("\u062a\u0641\u0627\u0635\u064a\u0644 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631"),self)
        self.label2.setFont(QFont('Arial', 22))
        self.label2.setStyleSheet('background-color:white; color: black')
        self.label2.setGeometry(450,110,200,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        self.back = QPushButton(back, self)
        self.back.setGeometry(680,610,241,80)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet(stylesheet.back)
        self.back.clicked.connect(self.call_first1)
...
#         self.exportgraph.clicked.connect(self.call_first1)
        ...
        self.graphWidget.setLabel('left', str("\u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629"))
        ...
        self.print = QPushButton(str("\u0627\u0637\u0628\u0639"), self)
        self.print.setGeometry(480,610,180,80)
        self.print.setFont(QFont('Arial', 21))
        self.print.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        #self.print.clicked.connect(self.call_first1)
        self.exportcsv = QPushButton(str("\u062a\u0635\u062f\u064a\u0631 \u0043\u0073\u0076 \u0625\u0644\u0649 \u0055\u0053\u0042"), self)
        self.exportcsv.setGeometry(280,610,180,80)
        self.exportcsv.setFont(QFont('Arial', 21))
        self.exportcsv.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        #self.exportcsv.clicked.connect(self.call_first1)
        self.exportgraph = QPushButton(str("\u062d\u0641\u0638 \u0641\u064a \u0055\u0073\u0062"), self)
        self.exportgraph.setGeometry(80,610,180,80)
        self.exportgraph.setFont(QFont('Arial', 21))
        self.exportgraph.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        self.username.setFont(QFont('Arial', 19))
        self.username.setStyleSheet('background-color:white; color: black;')
        self.username.setGeometry(100,395,170,75)
        self.username.setText(self.set_username)
        
        self.status = QLabel(self)
        self.status.setFont(QFont('Arial', 19))
        self.status.setStyleSheet('background-color:white; color: black;')
        self.status.setGeometry(100,505,170,75)
...
class result_window(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u0628\u064a\u0627\u0646\u0627\u062a \u0627\u0644\u0646\u062a\u0627\u0626\u062c"),self)
        ...
        back="             \u0631\u062c\u0648\u0639          \u2190"
        self.back = QPushButton(back, self)
        self.back.setGeometry(30,202,230,70)
        ...
        self.exp_result = QPushButton(str("\u062a\u0635\u062f\u064a\u0631 \u0643\u0644 \u0627\u0644\u0646\u062a\u0627\u0626\u062c"), self)
        self.exp_result.setGeometry(750,202,230,70)
        ...
        self.show_aresult = QPushButton(str("\u0625\u0638\u0647\u0627\u0631 \u0643\u0644 \u0627\u0644\u0646\u062a\u0627\u0626\u062c"), self)
        self.show_aresult.setGeometry(510,202,230,70)
        ...
        self.view_result = QPushButton(str("\u0631\u0624\u064a\u0629 \u0627\u0644\u0646\u062a\u064a\u062c\u0629"), self)
        self.view_result.setGeometry(270,202,230,70)
        ...
        self.comboBox.setGeometry(680, 310, 231, 60)
        ...
        self.comboBox.addItem(str("\u062a\u0627\u0631\u064a\u062e"))
        self.comboBox.addItem(str("\u062f\u0631\u062c\u0629 \u062d\u0631\u0627\u0631\u0629"))
        self.comboBox.addItem(str("\u0627\u0644\u0645\u0624\u0642\u062a"))
        self.comboBox.addItem(str("\u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"))
        self.comboBox.addItem(str("\u0633\u0631\u0639\u0629 \u0627\u0644\u0645\u0631\u0648\u062d\u0629"))
        self.comboBox.addItem(str("\u0645\u0633\u062a\u0648\u0649"))
        self.comboBox.addItem(str("\u062d\u0627\u0644\u0629"))
        ...
        self.search.setPlaceholderText(str("\u0623\u062f\u062e\u0644 \u0627\u0644\u0643\u0644\u0645\u0629 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629"))
        ...
        self.search_b = QPushButton(str("\u0628\u062d\u062b"), self)
        self.search_b.setGeometry(150,310,200,60)
        ...
        self.dataView.setHeaderLabels([str("\u062d\u0627\u0644\u0629"),str("\u0645\u0633\u062a\u0648\u0649"),str("\u0633\u0631\u0639\u0629 \u0627\u0644\u0645\u0631\u0648\u062d\u0629"),str("\u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"),str("\u0627\u0644\u0645\u0624\u0642\u062a"),str("\u062f\u0631\u062c\u0629 \u062d\u0631\u0627\u0631\u0629"),str("\u062a\u0627\u0631\u064a\u062e"),str("\u0631\u0642\u0645\n")])
...
#ui->myTreeWidget->header()->setDefaultAlignment(Qt::AlignCenter);
        ...
        #self.dataView.setSizeHint(0,QSize(10,10))
        self.dataView.setColumnWidth(0,130)#(130)..
        self.dataView.setColumnWidth(1,120)#(120)..
        self.dataView.setColumnWidth(2,100)#(100)..
        self.dataView.setColumnWidth(3,180)#(180)..
        self.dataView.setColumnWidth(4,130)#(130)..
        self.dataView.setColumnWidth(5,120)#(120)..
        self.dataView.setColumnWidth(6,140)#(140)..
        self.dataView.setColumnWidth(7,0)
        self.dataView.setAlternatingRowColors(True)
        #self.dataView.setColumnWidth(8,100)
        #QTreeWidgetItem.setTextAlignment(Qt.AlignRight)
    ...
    def insert_data(self):
            ...
            for i,x in enumerate(l):
                ...
                xa=QTreeWidgetItem(self.dataView,[x[7],x[6],x[5],x[4],x[3],x[2],x[0]+str('\n')+x[1],str(i),x[8]]) 
            
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
                xa.setTextAlignment(2,Qt.AlignRight)
                xa.setTextAlignment(3,Qt.AlignRight)
                xa.setTextAlignment(4,Qt.AlignRight)
                xa.setTextAlignment(5,Qt.AlignRight)
                xa.setTextAlignment(6,Qt.AlignRight)
                xa.setTextAlignment(7,Qt.AlignRight)
                xa.setTextAlignment(8,Qt.AlignRight)
            conn.commit()
            c.close()
            conn.close()
    def view_result1(self):
        ...
        try:
            ...
            print("error")
            self.popup1=popup1(name='\u0645\u0646 \u0641\u0636\u0644\u0643 \u0627\u062e\u062a\u0631 \u0623\u064a \u0642\u064a\u0645\u0629 ',name2='Close')
            self.popup1.show()
    def view_search(self):
        ...
        temp_search.strip()
        if(temp_search==str("\u062a\u0627\u0631\u064a\u062e")):
          temp_search="Date"
        elif(temp_search==str("\u062f\u0631\u062c\u0629 \u062d\u0631\u0627\u0631\u0629")):
          temp_search="Temperature"
        elif(temp_search==str("\u0627\u0644\u0645\u0624\u0642\u062a")):
          temp_search="Timer"
        elif(temp_search==str("\u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645")):
          temp_search="Username"
        elif(temp_search==str("\u0633\u0631\u0639\u0629 \u0627\u0644\u0645\u0631\u0648\u062d\u0629")):
          temp_search="FanSpeed"
        elif(temp_search==str("\u0645\u0633\u062a\u0648\u0649")):
          temp_search="Level"
        elif(temp_search==str("\u062d\u0627\u0644\u0629")):
          temp_search="Status"
...
class selectuserscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        self.label = QLabel(str("\u062a\u062d\u062f\u064a\u062f \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(300,125,270,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        ...
        self.selectuser = QPushButton(str("\u0627\u062e\u062a\u0631 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"), self)
        self.selectuser.setGeometry(350,202,241,61)
        self.selectuser.setFont(QFont('Arial', 21))
        self.selectuser.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
...
"padding: 4px; color: black")
        ...
        self.dataView.setAlternatingRowColors(True)
        self.dataView.setRootIsDecorated(False)
        self.dataView.setHeaderLabels([str("\u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"),str("\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062c\u0639\u064a")])
        self.dataView.header().setStyleSheet('padding-top:-2px;background-color:white;font-size:21pt; font-family: Arial;border-width:1px;border-style:outset;border-color:black; ')
        self.dataView.header().setDefaultAlignment(Qt.AlignRight)
        #self.dataView.header().setResizeMode(1, QHeaderView.Stretch)
        #self.dataView.header().setResizeMode(2, QHeaderView.Stretch)
    ...
    def onItemClicked(self):
        ...
        #if getSelected:
        baseNode = getSelected[0]
        self.getChildNode = baseNode.text(0)
        #self.dataView.setIconSize(QSize(32,32))
        #self.create_table()
    ...
    def insert_data(self):
            ...
            for i,x in enumerate(l):
                #print(i,x)
                xa=QTreeWidgetItem(self.dataView,[x[0],str(i)])
                xa.setTextAlignment(0,Qt.AlignRight)
                xa.setTextAlignment(1,Qt.AlignRight)
    def call_back(self):
        self.close()
    ...
    def call_select(self):
        ...
        try:
            ...
            self.popup1=popup1(name=str("\u0645\u0646 \u0641\u0636\u0644\u0643 \u0627\u062e\u062a\u0631 \u0623\u064a \u0645\u0633\u062a\u062e\u062f\u0645 \u0644\u0644\u0627\u0633\u062a\u0643\u0645\u0627\u0644          "),name2=str("\u062d\u0633\u0646\u064b\u0627"))
            self.popup1.show()
    ...
    def enter1(self):
        if(self.previouswindow=='hours' ):
            try:
                ...
                self.popup1=popup1(name='\u0645\u0646 \u0641\u0636\u0644\u0643 \u0623\u062f\u062e\u0644 \u0623\u0642\u0644 \u0645\u0646 \u0036\u0030 \u062f\u0642\u064a\u0642\u0629',name2='Close')
                self.popup1.show()
            except ValueError:
                self.popup1=popup1(name='\u0645\u0646 \u0641\u0636\u0644\u0643 \u0623\u062f\u062e\u0644 \u0623\u0642\u0644 \u0645\u0646 \u0036\u0030 \u062f\u0642\u064a\u0642\u0629',name2='Close')
                self.popup1.show()
    ...
    def enter1(self):
        if(self.previouswindow=='temperature'or self.previouswindow=='e_p1' or self.previouswindow=='e_p2'or self.previouswindow=='e_p3'):
            try:
                ...
                self.popup1=popup1(name='\u0645\u0646 \u0641\u0636\u0644\u0643 \u0623\u062f\u062e\u0644 \u062f\u0631\u062c\u0629 \u062d\u0631\u0627\u0631\u0629 \u0623\u0642\u0644 \u0645\u0646 \u0033\u0030\u0030 \u0648 \u0623\u0639\u0644\u0649 \u0645\u0646 \u062f\u0631\u062c\u0629 \u062d\u0631\u0627\u0631\u0629 \u0627\u0644\u063a\u0631\u0641\u0629',name2='Close')
                self.popup1.show()
            except ValueError:
                self.popup1=popup1(name='\u0645\u0646 \u0641\u0636\u0644\u0643 \u0623\u062f\u062e\u0644 \u062f\u0631\u062c\u0629 \u062d\u0631\u0627\u0631\u0629 \u0623\u0642\u0644 \u0645\u0646 \u0033\u0030\u0030 \u0648 \u0623\u0639\u0644\u0649 \u0645\u0646 \u062f\u0631\u062c\u0629 \u062d\u0631\u0627\u0631\u0629 \u0627\u0644\u063a\u0631\u0641\u0629',name2='Close')
                self.popup1.show()
...
class graphresultwindow(QMdiSubWindow):
    ...
    def InitUI1(self):
        ...
        self.label2.setStyleSheet('background-color:white; color: black')
        self.label2.setGeometry(450,110,200,50)
        self.back = QPushButton(str("\u0627\u0644\u0635\u0641\u062d\u0629 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629"), self)
        self.back.setGeometry(680,610,180,80)
        self.back.setFont(QFont('Arial', 21))
...
class runninggraphwindow(QMdiSubWindow):
    ...
    def update_plot_data(self):
        ...
        store.temp_list.append(x_t)
        if(len(self.temperature)>5000):
          self.temperature=self.temperature[1:]
        
        mainwindow1.toptext=str("\u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629 \u0627\u0644\u062d\u0627\u0644\u064a\u0629")+"  "+str(x_t)  # Add a new random value.
        ...
        #             self.label_warning.setText(u'\u0021')
        #             self.c_b=1
        #         elif(self.c_b==1):
        #             self.buzzer_run1=self.buzzer_run1+1
        #             self.label_warning.setText('')
        #             self.c_b=2
        #         if(self.buzzer_run1==10):
        #                  insert_temperature='low_temperature'
        #                  if only_temperature==1:
        #                     only_temperature=0
        #                     timing_temperature=1 
        #                     temp_time = threading.Thread(target=temperature_time,args=()) 
        #                     temp_time.start()
        #                  call_buzzer()

        # if (float(x_t)>=float(starttestdata.temperature)+temperature_limit.limit and self.dusra_variable==1):
        #       if(self.c_b==2):
        #             self.buzzer_run=self.buzzer_run+1
        #             self.label_warning.setText(u'\u0021')
        #             self.c_b=1
        #       elif(self.c_b==1):
        #             self.buzzer_run=self.buzzer_run+1
        ...
        #       if(self.buzzer_run==10):
        #                  insert_temperature='high_temperature'
        #                  if only_temperature==1:
        #                     only_temperature=0
        #                     timing_temperature=1 
        #                     temp_time = threading.Thread(target=temperature_time,args=()) 
    ...
    def startUI(self):
        if(starttestdata.hours==str("infinity")):
            ...
            mainwindow1.lowertext=str("          \u0627\u0644\u0645\u0624\u0642\u062a")+"  "+str("\u0627\u0644\u0644\u0627\u0646\u0647\u0627\u064a\u0629")
            self.inf=External3()
            self.inf.start()
        else:
            self.time_show=str(starttestdata.hours)+'Hrs'+str(starttestdata.minutes)+'Mins'
            mainwindow1.lowertext=str("           \u0627\u0644\u0645\u0624\u0642\u062a ")+"  "+str(self.time_show)
    ...
    def InitUI(self):
        ...
        self.set_temp = QLabel(str("\u062a\u062d\u062f\u064a\u062f \u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629"),self)
        self.set_temp.setFont(QFont('Arial', 17))
        self.set_temp.setStyleSheet('background-color:#03002E; color: white;')
        self.set_temp.setGeometry(280,540,200,40)
        
        self.set_temp_data = QLabel(self)
        self.set_temp_data.setFont(QFont('Arial', 17))
        self.set_temp_data.setStyleSheet('background-color:#03002E; color: white;padding-top:8px')
        self.set_temp_data.setGeometry(100,540,200,40)
        self.set_temp_data.setAlignment(Qt.AlignRight)
        self.set_temp_data.setText(starttestdata.temperature)

        self.set_timer = QLabel(str("\u062a\u062d\u062f\u064a\u062f \u0627\u0644\u0645\u0624\u0642\u062a     "),self)
        self.set_timer.setFont(QFont('Arial', 17))
        self.set_timer.setStyleSheet('background-color:#03002E; color: white;padding-top:8px')
        #self.set_timer.raise_()
        self.set_timer.setAlignment(Qt.AlignRight)
        self.set_timer.setGeometry(780,540,160,40)
        
        self.set_timer_data = QLabel(self)
        self.set_timer_data.setFont(QFont('Arial', 17))
        self.set_timer_data.setStyleSheet('background-color:#03002E; color: white;padding-top:8px')
        self.set_timer_data.setGeometry(480,540,300,40)
...
"padding: 4px; color: black")
        #self.buttonWindow12.move(100, 100)
        self.Home.clicked.connect(self.call_home)
        self.stoptest = QPushButton(str("\u0625\u064a\u0642\u0627\u0641 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631"), self)
...
"padding: 4px; color: black")
    ...
    def popup_stoptest(self):
            ...
            label1.setStyleSheet('background-color:white;border:0px solid white')
            label1.move(236,130)
            label2 = QLabel('\u0647\u0644 \u0623\u0646\u062a \u0645\u062a\u0623\u0643\u062f \u0623\u0646\u0643 \u062a\u0631\u064a\u062f \u0625\u064a\u0642\u0627\u0641 \u0647\u0630\u0627 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631',a)
            label2.setFont(QFont('Arial', 19))
            label2.setStyleSheet('background-color:white;border:0px solid white')
            label2.move(50,170)
            yes_delete = QPushButton(str("\u0646\u0639\u0645\u0021"), a)
...
class startwindow(QMdiSubWindow):
    ...
    def setupUi(self):
        ...
        self.TestScreen.setGeometry(QRect(410, 120, 221, 41))
        font = QFont()
        ...
        self.TestScreen_2.setGeometry(QRect(750, 330, 200, 31))
        font = QFont()
        font.setFamily("Arial")
...
"font: 75 16pt \"Arial\";")
        ...
        self.TestScreen_3.setGeometry(QRect(750, 410, 200, 31))
        font = QFont()
        font.setFamily("Arial")
...
"font: 75 16pt \"Arial\";")
        ...
        self.TestScreen_4.setGeometry(QRect(750, 490, 200, 31))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.comboBox.setStyleSheet("QComboBox{font: 87 15pt \"Arial\";background-color: rgb(241, 241, 241);}")
        self.comboBox.setGeometry(QRect(210, 480, 191, 41))
        self.comboBox.setCursor(QCursor(Qt.ArrowCursor))
        self.comboBox.setAcceptDrops(False)
        ...
        self.TestScreen_5.setGeometry(QRect(750, 570, 200, 31))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.TestScreen_6.setGeometry(QRect(750, 650, 200, 31))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.comboBox_2.setGeometry(QRect(210, 560, 201, 41))
        self.comboBox_2.setCursor(QCursor(Qt.ArrowCursor))
        self.comboBox_2.setAcceptDrops(False)
        ...
        self.pushButton.setGeometry(QRect(700, 202, 291, 71))
...
"padding: 4px; color: black")
        ...
        self.pushButton_2.setGeometry(QRect(60, 202, 241, 61))
...
"padding: 4px; color:black ")
        ...
        self.label.setStyleSheet('background-color:white;color: black;')
        self.label.setGeometry(450,390,57,45)
        self.retranslateUi()
        self.inserteditdata()
    ...
    def retranslateUi(self):
       # _translate = QCoreApplication.translate
        self.setWindowTitle( str("\u0627\u0644\u0628\u062f\u0621 \u0641\u064a \u0625\u062c\u0631\u0627\u0621 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631"))
        self.TestScreen.setText(str("\u062a\u062d\u062f\u064a\u062f \u0627\u0644\u0645\u062a\u063a\u064a\u0631\u0627\u062a"))
        self.TestScreen_2.setText(str("\u062a\u062d\u062f\u064a\u062f \u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629"))
        self.TestScreen_3.setText( str("\u0636\u0628\u0637 \u0627\u0644\u0645\u0624\u0642\u062a \u002f \u0648\u0636\u0639 \u0627\u0644\u0644\u0627\u0646\u0647\u0627\u064a\u0629"))
        self.TestScreen_4.setText( str("\u062a\u062d\u062f\u064a\u062f \u0645\u0633\u062a\u0648\u0649"))
        self.comboBox.setItemText(0,  str("\u0633\u0631\u064a\u0639"))
        self.comboBox.setItemText(1, "\u0645\u062a\u0648\u0633\u0637")
        self.comboBox.setItemText(2, "\u0628\u0637\u0626")
        self.TestScreen_5.setText(str("\u062a\u062d\u062f\u064a\u062f \u0633\u0631\u0639\u0629 \u0627\u0644\u0645\u0631\u0648\u062d\u0629"))
        self.TestScreen_6.setText(str("\u062a\u062d\u062f\u064a\u062f \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"))
        ...
        self.pushButton.setText(str("\u062a\u062d\u062f\u064a\u062f \u0627\u0644\u0645\u062a\u063a\u064a\u0631\u0627\u062a"))
        self.pushButton_2.setText(str("\u2190               \u0631\u062c\u0648\u0639               "))
...
class subwindow2(QMainWindow):
    ...
    def updateTime(self):
        ...
        if(testclass.test=="running"):
            ...
            c_temperature=str('\u062f\u0631\u062c\u0629 \u0627\u0644\u062d\u0631\u0627\u0631\u0629 \u0627\u0644\u062d\u0627\u0644\u064a\u0629')
...
class subwindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        #self.setWindowFlags(QtCore.Qt.WindowStaysOnTopHint)
        self.setWindowFlags(Qt.WindowStaysOnTopHint  | Qt.FramelessWindowHint)
        da1217_arbi=str("\u0623\u0647\u0644\u0627 \u0628\u0643\u0645 \u0641\u064a  \u0044\u0041\u002d\u0031\u0032\u0031\u0037")
        self.da1217=QLabel(da1217_arbi,self)
        self.da1217.setFont(QFont('Arial',24))
        self.da1217.setGeometry(360,70,300,155)
        start_test_arbi=str('\u0627\u0628\u062f\u0623 \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631')
        buttonWindow1 = QPushButton(start_test_arbi, self)
        buttonWindow1.setFont(QFont('Arial', 27))
        buttonWindow1.setGeometry(680,180,285,155)
        buttonWindow1.setStyleSheet('background-image: url(start2.png); color:#10477b;')
        buttonWindow1.clicked.connect(self.buttonWindow1_onClick)
        settings_arbi=str('\u0627\u0644\u0625\u0639\u062f\u0627\u062f\u0627\u062a')
        Settings = QPushButton(settings_arbi, self)
        Settings.setFont(QFont('Arial', 27))
        Settings.setGeometry(680,370,285,155)
        Settings.setStyleSheet('background-image: url(setting3.png); color:#10477b;')
        Settings.clicked.connect(self.settingswindow)
        user_arbi=str("\u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645")
        User = QPushButton(user_arbi, self)
        User.setFont(QFont('Arial', 27))
        User.setGeometry(680,560,285,155)
        User.setStyleSheet('background-image: url(user3.png); color:#10477b;')
        User.clicked.connect(self.userswindow)
        
        result_arbi=str("\u0627\u0644\u0646\u062a\u0627\u0626\u062c")
        Results = QPushButton(result_arbi, self)
        Results.setFont(QFont('Arial', 27))
        Results.setGeometry(370,180,285,155)
        Results.setStyleSheet('background-image: url(Result3.png); color:#10477b;')
        Results.clicked.connect(self.resultswindow)
        
        #windoww.win.addSubWindow(self.rw)
        about_arbi=str("\u0639\u0646")
        About = QPushButton(about_arbi, self)
        About.setFont(QFont('Arial', 27))
        About.setGeometry(370,370,285,155)
        About.setStyleSheet('background-image: url(about3.png);color:#10477b;')
        About.clicked.connect(self.aboutwindow)
        damper_arbi=str('\u0627\u0644\u0645\u062b\u0628\u0637')
        Damper = QPushButton(damper_arbi, self)
        Damper.setFont(QFont('Arial', 27))
        Damper.setGeometry(370,560,285,155)
        Damper.setStyleSheet('background-image: url(damper3.png);color:#10477b;')
        Damper.clicked.connect(self.damperwindow)
        self.n = QPushButton(self)
        self.n.setFont(QFont('Arial', 27))
        self.n.setGeometry(200,630,50,50)
        self.n.setStyleSheet('background-image: url(notification1.png);border: none;border-style: outset;')
        self.s = QPushButton(self)
        self.s.setCheckable(True)
        self.s.setFont(QFont('Arial', 27))
        ...
        self.s.setStyleSheet(("QPushButton{background-image: url(sound_on.png); color: white;border: none;} QPushButton:checked { background-image: url(sound_off.png);color:black; }"))
        self.s.clicked.connect(lambda sounds:self.control(sounds))
        self.s.setGeometry(115,630,80,50)
...
class userswindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setPixmap(QPixmap('background1.png'))
        self.label.setGeometry(0,100,1024,668)
        users_data_arbi=str("\u0628\u064a\u0627\u0646\u0627\u062a \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645")
        self.label = QLabel(users_data_arbi,self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(300,120,320,50)

        back="\u2190      \u0631\u062c\u0648\u0639        "#self.pushButton_2.setGeometry(QRect(60, 202, 241, 61))
        self.back = QPushButton(back, self)
        self.back.setGeometry(30,202,220,61)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet(stylesheet.back)
        self.back.clicked.connect(self.call_back)
        addnewuser_arbi=str("\u0625\u0636\u0627\u0641\u0629 \u0645\u0633\u062a\u062e\u062f\u0645 \u062c\u062f\u064a\u062f")
        self.addnewuser = QPushButton(addnewuser_arbi, self)
        self.addnewuser.setGeometry(750,200,220,61)
...
padding: 4px; color: black''')
        ...
        edituser_arbi="\u062a\u0639\u062f\u064a\u0644 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"
        self.edituser = QPushButton(edituser_arbi, self)
        self.edituser.setGeometry(510,200,220,61)
...
padding: 4px; color: black''')
        ...
        deleteuser_arbi=str("\u0625\u0644\u063a\u0627\u0621 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645")
        self.deleteuser = QPushButton(deleteuser_arbi, self)
        self.deleteuser.setGeometry(270,200,220,61)
...
# tree.setItemDelegate(delegate)
        ...
        #self.dataView.setAlternatingRowColors(True)
        heading_user_arbi=str("\u0627\u0644\u0627\u0633\u0645")
        heading_employer_arbi=str("\u0627\u0644\u0645\u0648\u0638\u0641")
        heading_contact_arbi=str("\u062c\u0647\u0629 \u0627\u0644\u0627\u062a\u0635\u0627\u0644")
        heading_designation_arbi=str("\u0627\u0644\u062a\u0639\u064a\u064a\u0646")
        self.dataView.setHeaderLabels([heading_designation_arbi,heading_contact_arbi,heading_employer_arbi,heading_user_arbi,str("\u0631\u0642\u0645")])
        self.dataView.header().setDefaultAlignment(Qt.AlignRight)
        #self.dataView.header().setStyleSheet('padding-top:-2px;background-color:white;font-size: 21pt; font-family: Arial;border-width:1px;border-style:outset;border-color:black; ')
...
# tree.header().setFont(font)
       ...
       #self.dataView.header().setResizeMode(False)
        self.dataView.setColumnCount(5)
        #self.dataView.setSizeHint(0,QSize(10,10))
        self.dataView.setColumnWidth(0,220)
...
##           QTreeWidgetItem(self.dataView,x) 
    ...
    def call_delete1(self):
        ...
        try:
            ...
            label1.setStyleSheet('background-color:white;border:0px solid white')
            label1.move(236,130)
            label2 = QLabel(str(" \u0647\u0644 \u0623\u0646\u062a \u0645\u062a\u0623\u0643\u062f \u0623\u0646\u0643 \u062a\u0631\u064a\u062f \u0625\u0644\u063a\u0627\u0621 \u0647\u0630\u0627 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645\u0021           "),a)
            label2.setFont(QFont('Arial', 19))
            label2.setStyleSheet('background-color:white;border:0px solid white')
            label2.move(50,170)
            yes_delete = QPushButton(str("\u0646\u0639\u0645\u0021"), a)
            ...
            print("error")
            self.popup1=popup1(name=str("\u0645\u0646 \u0641\u0636\u0644\u0643 \u0627\u062e\u062a\u0631 \u0623\u064a \u0645\u0633\u062a\u062e\u062f\u0645 \u0644\u0644\u0627\u0633\u062a\u0643\u0645\u0627\u0644\u0021            "),name2='\u062d\u0633\u0646\u064b\u0627\u0021')
            self.popup1.show()
    ...
    def call_edit(self):
        ...
        try:
            ...
            print("error")
            self.popup1=popup1(name=str("\u0645\u0646 \u0641\u0636\u0644\u0643 \u0627\u062e\u062a\u0631 \u0623\u064a \u0645\u0633\u062a\u062e\u062f\u0645 \u0644\u0644\u062a\u0639\u062f\u064a\u0644\u0021              "),name2=str("\u062d\u0633\u0646\u064b\u0627\u0021"))
            self.popup1.show()
...
#self.entry = extQLineEdit(self,'entry2')
        ...
        self.e_user.setGeometry(70,330,493,53)
        self.e_user.setStyleSheet('background-color:white; color: black')
        self.e_user.setPlaceholderText(str("\u0623\u062f\u062e\u0644 \u0627\u0644\u0627\u0633\u0645"))
        ...
        self.e_employer.setGeometry(70,405,492,53)
        self.e_employer.setStyleSheet('background-color:white; color: black')
        self.e_employer.setPlaceholderText(str("\u0623\u062f\u062e\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"))
        ...
        self.e_contact.setGeometry(70,475,493,53)
        self.e_contact.setStyleSheet('background-color:white; color: black')
        self.e_contact.setPlaceholderText(str("\u0623\u062f\u062e\u0644 \u062c\u0647\u0629 \u0627\u0644\u0627\u062a\u0635\u0627\u0644"))
        ...
        self.user.setGeometry(630,350,300,30)
        employer_arbi=str("\u0623\u062f\u062e\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645")
        ...
        self.employer_id.setGeometry(630,420,300,30)

        self.contact = QLabel(str("\u0623\u062f\u062e\u0644 \u062c\u0647\u0629 \u0627\u0644\u0627\u062a\u0635\u0627\u0644"),self)
        self.contact.setFont(QFont('Arial', 19))
        self.contact.setStyleSheet('background-color:white; color: black')
        self.contact.setGeometry(630,490,300,30)

        self.designation = QLabel(str("\u0623\u062f\u062e\u0644 \u0627\u0644\u062a\u0639\u064a\u064a\u0646"),self)
        self.designation.setFont(QFont('Arial', 19))
        self.designation.setStyleSheet('background-color:white; color: black')
        self.designation.setGeometry(630,560,300,30)
        #self.exec_()
##    def __del__(self):
...
##        gc.collect()
    ...
    def call_add(self):
        ...
        try:
            ...
            windoww.win.addSubWindow(self.swindow)
            self.swindow.show()
            self.popup2=popup2(name=str("\u062a\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645                    "),name2=str("\u0623\u063a\u0644\u0642\u0021"))
            self.popup2.show()

        except ValueError:
                print("error")
                self.popup1=popup1(name=str('\u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645 \u0645\u0648\u062c\u0648\u062f \u0628\u0627\u0644\u0641\u0639\u0644             '),name2=str("\u0623\u063a\u0644\u0642\u0021"))
                self.popup1.show()
        except NameError:
                print("error")
                self.popup1=popup1(name='\u0645\u0646 \u0641\u0636\u0644\u0643 \u0623\u062f\u062e\u0644 \u0643\u0644 \u0627\u0644\u0642\u064a\u0645 ',name2='Close')
...
##        #self.pixmap = QPixmap('header.png')
        ...
        self.label = QLabel(str("\u062a\u0639\u062f\u064a\u0644 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645 \u0627\u0644\u062d\u0627\u0644\u064a"),self)
        self.label.setFont(QFont('Arial', 27))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(300,125,320,50)
        back="\u2190      \u0631\u062c\u0648\u0639        "
        ...
        self.addnewuser = QPushButton(str("\u062a\u0639\u062f\u064a\u0644 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645"), self)
        self.addnewuser.setGeometry(335,202,241,61)
        self.addnewuser.setFont(QFont('Arial', 21))
        self.addnewuser.setStyleSheet('''background-color:#4299ff;border: none;border-style: outset;
border-width: 0.5px;
