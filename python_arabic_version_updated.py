...
"padding: 4px; color: black")
        ...
        self.back.setGeometry(80,170,200,60)
...
class masterpasswordscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.nsp.setGeometry(590,220,270,50)
        ...
        self.cp.setGeometry(590,340,270,50)


        self.e_nsp = extQLineEdit1(self)
        self.e_nsp .setFont(QFont('Arial', 18))
        self.e_nsp .setGeometry(90,220,500,53)
        ...
        self.e_cp.setGeometry(90,340,500,53)
...
class servicepasswordscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.lcp.setGeometry(590,220,270,50)
        ...
        self.lnp.setGeometry(590,340,270,50)
        ...
        self.lcnp.setGeometry(590,460,270,50)

        self.e_cp = extQLineEdit1(self)
        self.e_cp .setFont(QFont('Arial', 18))
        self.e_cp .setGeometry(90,220,500,53)
        self.e_cp .setStyleSheet('background-color:white; color: black')
        ...
        self.e_np.setGeometry(90,340,500,53)
        ...
        self.e_cnp.setGeometry(90,460,500,53)
...
class performance(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(100,230,240,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
class alarmscreen(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(105,200,240,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
class second_servicewindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.home.setGeometry(50,160,140,70)
...
"padding: 4px; color: black")
        ...
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(220,160,140,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
class settingswindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label2.setFont(QFont('Arial', 26))
        self.label2.setStyleSheet('background-color:white; color: black')
        self.label2.setGeometry(350,120,220,50)
...
class instrumentwindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setGeometry(400,120,220,50)
        self.home = QPushButton(str("\u0627\u0644\u0635\u0641\u062d\u0629 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629"), self)
        self.home.setGeometry(250,180,140,70)
        self.home.setFont(QFont('Arial', 19))
        self.home.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(420,180,140,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        self.back.clicked.connect(self.call_back)
        self.save = QPushButton(str("\u062d\u0641\u0638"), self)
        self.save.setGeometry(80,180,140,70)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        self.c_name.setGeometry(590,230,220,50)
        self.c_name_entry = extQLineEdit1(self)
        self.c_name_entry.setFont(QFont('Arial', 16))
        self.c_name_entry.setGeometry(590,270,240,40)
        ...
        self.tele_no.setGeometry(590,330,220,50)
        self.tele_no_entry = extQLineEdit1(self)
        self.tele_no_entry.setFont(QFont('Arial', 16))
        self.tele_no_entry.setGeometry(590,370,240,40)
        ...
        self.time.setGeometry(590,430,220,50)
        self.s1 = Switch(self,thumb_radius=24, track_radius=25,text='Time')
        self.s1.setGeometry(630,470,120,50)
        ...
        self.temperature.setGeometry(590,540,220,50)
        self.s2 = Switch(self,thumb_radius=24, track_radius=25,text='Temperature')
        self.s2.setGeometry(630,580,120,50)
        ...
        self.progress_l .setGeometry(590,640,220,50)
        self.progress = QProgressBar(self)
        self.progress.setGeometry(520, 680, 300, 25)
        ...
        self.progress_2 .setGeometry(480,665,35,50) 
        ...
        self.screentimeout.setGeometry(200,330,220,50)
        self.b_timeout = QPushButton(str("\u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0647\u0644\u0629"), self)
        self.b_timeout.setGeometry(200,380,240,90)
...
# "border-color: black;\n"
# "padding: 4px; color: black")
        self.printer.setGeometry(200,490,220,50)
        self.b_printer = QPushButton(str('\u0627\u062e\u062a\u0631 \u0627\u0644\u0637\u0627\u0628\u0639\u0629'), self)
        self.b_printer.setGeometry(200,540,240,90)
...
class damper_screen(QMdiSubWindow):
    ...
    def InitUI1(self):
        ...
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(70,160,240,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet('''background-color:#4299ff;border: none;border-style: outset;
border-width: 0.5px;
border-radius: 0px;
...
class about_screen(QMdiSubWindow):
    ...
    def InitUI1(self):
        ...
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(450,110,90,50)
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(105,160,240,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet('''background-color:#4299ff;border: none;border-style: outset;
border-width: 0.5px;
border-radius: 0px;
...
class result_window(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        self.label.setStyleSheet('background-color:#f7f7ff; color: black')
        self.label.setGeometry(400,100,220,50)
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(30,160,230,70)
        ...
        self.exp_result.setGeometry(750,160,230,70)
        ...
        self.show_aresult.setGeometry(510,160,230,70)
        ...
        self.view_result.setGeometry(270,160,230,70)
        ...
        self.comboBox.setGeometry(680, 270, 231, 60)
        ...
        self.search_b.setGeometry(150,270,200,60)
...
#ui->myTreeWidget->header()->setDefaultAlignment(Qt::AlignCenter);
    ...
    def view_search(self):
        ...
        for i,x in enumerate(l):
            #print(i,x)
            QTreeWidgetItem(self.dataView,[x[7],x[6],x[5],x[4],x[3],x[2],x[0]+str('\n')+x[1],str(i),x[8]]) 
...
class startwindow(QMdiSubWindow):
    ...
    def setupUi(self):
        ...
        self.lineEdit.setGeometry(QRect(210, 270, 211, 41))
        ...
        self.lineEdit_2.setGeometry(QRect(210, 350, 101, 41))
        ...
        self.lineEdit_3.setGeometry(QRect(320, 350, 101, 41))
        ...
        self.lineEdit_6.setGeometry(QRect(200, 590, 231, 41))
        ...
        self.TestScreen_2.setGeometry(QRect(750, 280, 200, 31))
        font = QFont()
        font.setFamily("Arial")
...
"font: 75 16pt \"Arial\";")
        ...
        self.TestScreen_3.setGeometry(QRect(750, 360, 200, 31))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.TestScreen_4.setGeometry(QRect(750, 440, 200, 31))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.comboBox.setStyleSheet("QComboBox{font: 87 15pt \"Arial\";background-color: rgb(241, 241, 241);}")
        self.comboBox.setGeometry(QRect(210, 430, 191, 41))
        self.comboBox.setCursor(QCursor(Qt.ArrowCursor))
        self.comboBox.setAcceptDrops(False)
        ...
        self.TestScreen_5.setGeometry(QRect(750, 520, 200, 31))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.TestScreen_6.setGeometry(QRect(750, 600, 200, 31))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(False)
...
"font: 75 16pt \"Arial\";")
        ...
        self.comboBox_2.setGeometry(QRect(210, 510, 201, 41))
        self.comboBox_2.setCursor(QCursor(Qt.ArrowCursor))
        self.comboBox_2.setAcceptDrops(False)
        ...
        self.pushButton.setGeometry(QRect(60, 152, 291, 71))
...
"padding: 4px; color: black")
        ...
        self.pushButton_2.setGeometry(QRect(60, 670, 241, 61))
...
"padding: 4px; color: black")
        ...
        self.label.setStyleSheet('background-color:white;color: black;')
        self.label.setGeometry(450,340,57,45)
        self.retranslateUi()
        self.inserteditdata()
...
class stylesheet():
  ss='''background-color:white;border: none;border-style: outset;
border-width: 1px;
border-radius: 10px;
border-color: gray;
padding: 4px; color: black'''
...
class subwindow(QMdiSubWindow):
    ...
    def InitUI(self):
        ...
        buttonWindow1.setStyleSheet('background-image: url(start2.png);')
        buttonWindow1.clicked.connect(self.buttonWindow1_onClick)
...
padding: 4px; color: black''')
        ...
        self.addnewuser.setGeometry(750,200,240,70)
...
padding: 4px; color: black''')
        ...
        self.edituser.setGeometry(510,200,240,70)
...
padding: 4px; color: black''')
        ...
        self.deleteuser.setGeometry(270,200,240,70)
...
padding: 4px; color: black''')
        ...
        self.addnewuser.setGeometry(135,547,200,75)
        self.addnewuser.setFont(QFont('Arial', 21))
        self.addnewuser.setStyleSheet('''background-color:#4299ff;border: none;border-style: outset;
border-width: 0.5px;
border-radius: 0px;
...
#self.entry = extQLineEdit(self,'entry2')
        ...
        self.e_user.setGeometry(70,240,493,53)
        ...
        self.e_employer.setGeometry(70,315,492,53)
        ...
        self.e_contact.setGeometry(70,385,493,53)
        ...
        self.e_designation.setGeometry(70,455,492,53)
        ...
        self.user.setGeometry(630,270,300,30)
        ...
        self.employer_id.setGeometry(630,340,300,30)
        ...
        self.contact.setGeometry(630,410,300,30)
        ...
        self.designation.setGeometry(630,480,300,30)
        #self.exec_()
##    def __del__(self):
...
##        #self.pixmap = QPixmap('header.png')
        ...
        back=u'\u0627'+u'\u0644'+u'\u0631'+u'\u062C'+u'\u0648'+u'\u0639'
        self.back = QPushButton(back, self)
        self.back.setGeometry(355,547,190,75)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet('''background-color:#4299ff;border: none;border-style: outset;
border-width: 0.5px;
border-radius: 0px;
